export function TaskRequirements() {
  return (
    <>
      ...
      <ol>
        <li>
          Create a new React.js project and set up the necessary components and
          files.
        </li>
        <li>
        ...
        <li>
          Implement breadcrumb functionality to show the selected row's path or
          hierarchy.
        </li>
        <li>
          Handle breadcrumb navigation to allow the user to go back to previous
          levels.
        </li>
        <li>
          Apply appropriate styling using CSS or a CSS framework (e.g., Tailwind
          CSS, Bootstrap) to make the application visually appealing.
        </li>
        <li>
